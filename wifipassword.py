...
# Weather API app by Python created by me is not stored in GitHub because security purpose it is stored in the Python folder in the OneDrive\Desktop\Python folder